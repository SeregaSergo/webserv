...
# curl -F yo=@./tests/files/simple_body.txt "http://127.0.0.1:8080/upload" # multipart/form-data
# curl --data "param1=test1&param2=test2" http://localhost:8080   # application/x-www-form-urlencoded
...
# curl -X 'PUT' -d '{"param1":"test1","param2":"test3"}' http://bswag.com:8080/1  # different methods
