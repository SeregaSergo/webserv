...
curl -F yo=@simple_body.txt "http://127.0.0.1:8080/upload" # multipart/form-data
curl --data "param1=test1&param2=test2" http://bswag.com:8080   # application/x-www-form-urlencoded
